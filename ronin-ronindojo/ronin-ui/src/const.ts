...
export const NODE_CONFIG_PATH = process.env.NODE_CONFIG_PATH || "/app/data/docker-node.conf";
export const BITCOIND_CONFIG_PATH = process.env.BITCOIND_CONFIG_PATH || "/app/data/docker-bitcoind.conf";
